...
void processInput(GLFWwindow* window)
{
    ...
    if ((glfwGetKey(window, GLFW_KEY_H) == GLFW_PRESS) && !Input::keyboardKeysPressed['H']) {
        Input::keyboardKeysPressed['H'] = true;
    }
    if ((glfwGetKey(window, GLFW_KEY_H) == GLFW_RELEASE) && Input::keyboardKeysPressed['H']) {
        Input::keyboardKeysPressed['H'] = false;
    }
}
